...
export default function EditReceiptModal({ initial, loading, onSave, onClose }: EditReceiptModalProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
            <div className="bg-white rounded-2xl w-full max-w-md max-h-[90vh] overflow-y-auto p-5 sm:p-6">
                ...
                <div className="space-y-3">
                    <label className="block text-xs text-gray-500">
                        ...
                        <input
                            ...
                            className="mt-1 w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-blue-200"
                        />
                    </label>
                    <label className="block text-xs text-gray-500">
                        Sender name
                    ...
                    <label className="block text-xs text-gray-500">
                        ...
                        <textarea
                            ...
                            rows={2}
                            className="mt-1 w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-blue-200 resize-none"
                        />
                    </label>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-stretch gap-3 mt-6">
                    ...
                    <button
                        onClick={() => onSave(form)}
                        disabled={loading}
                        className="flex-1 h-11 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold transition-colors disabled:opacity-50"
                    >
